...
describe('Testing BisImage (from bisimage.js) a class that describes a 3D image with NIFTI I/O capabilities\n', function() {
    ...
    describe('\n\n      +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n\n check loading of ('+gold_fname+')', function(done) {    // jshint ignore:line
    ...
    describe('\n\n      +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n\n check loading of float ('+gold_fname2+')',  function(done) {     // jshint ignore:line
    ...
    describe('\n\n      +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n\n check loading and FORCE RAS of coronal and Sagittal',  function(done) {    // jshint ignore:line
    ...
    describe('\n\n      +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n\n check header codes',  function(done) {    // jshint ignore:line
