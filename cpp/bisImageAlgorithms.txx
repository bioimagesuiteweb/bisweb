...
namespace bisImageAlgorithms {
  ...
  template<class IT,class OT> std::unique_ptr<bisSimpleImage<OT> >  thresholdImage(bisSimpleImage<IT>* input,float thresholds[2],int replace[3],OT replacevalue[2])
  {
