...
class individualizedParcellation(bis_basemodule.baseModule):
    ...
    def createDescription(self):
        obj=modules_desc.descriptions['individualizedParcellation'];
        obj['params'].append(
            {
                "name": "usefloat",
...
if __name__ == '__main__':
    ...
    import bis_commandline; sys.exit(bis_commandline.loadParse(individualizedParcellation(),sys.argv,False));
