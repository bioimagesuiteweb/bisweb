...
const bis3dOrthogonalSlice = {
     ...
     */
    create2dslice : function(volume,in_plane,decorationmode,objectmap,transparent) {
     ...
     */
    create3cardslice : function(vol,in_slices,decorations,transparent,imageplane) {
        ...
        var output = {
            ...
            interpolate : function (dointerpolate=false) {
                if (dointerpolate);
            },
...
module.exports = bis3dOrthogonalSlice;
