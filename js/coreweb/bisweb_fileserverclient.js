...
class BisWebFileServerClient extends BisFileServerClient { 
    ...
    //Wrapper functions to display errors generated by the base class on the UI
    ...
    handleDownloadedFile(url, isbinary, msg, resolve) {
       try {
           super.handleDownloadedFile(url, isbinary, msg, resolve);
       } catch(e) {
           webutil.createAlert('An error occured while handling ' + url, true);
           console.log('An error occured while handling', url, e);
       }
    }
}
