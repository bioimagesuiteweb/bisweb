    ...
    createHeader() {
        ...
        if (this.options.initialstate === "docked" && this.options.dual===false) {
            ...
            if (this.options.helpButton) {
                this.dockHelpButton=$(`<button type="button" class="bistoggle bisflip"><span class="glyphicon glyphicon-info-sign bisweb-help-button"></span></button>`);
        ...
        if (this.options.helpButton) {
            this.helpButton=$(`<button type="button" class="bistoggle bisflip"><span class="glyphicon glyphicon-info-sign bisweb-help-button"></span></button>`);
