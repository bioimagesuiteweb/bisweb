...
const objectmapcolormap=[ [ 0,0,0,0 ],
                          [ 255,0,0,255 ],
                          [ 255,158,0,255 ],
                          [ 255,255,0,255 ],
                          [ 0,255,0,255 ],
...
const util = {
    ...
    */
    ...
    /** This functions converts hex to rgb. 
     * @alias Util.getobjectmapcolor
     * @param {Number} i - color index into colormap objectmap
     * @returns {array} color i from objectmap colormap (0,255)
     */
    getobjectmapcolor : function(i) {

        let j=this.range(i,0,objectmapcolormap.length-1);
        return [ objectmapcolormap[j][0],
                 objectmapcolormap[j][1],
                 objectmapcolormap[j][2],
                 objectmapcolormap[j][3] ];
    },

    /** returns the length of the objectmap colormap length */
    getobjectmapcolormaplength : function() {
        return objectmapcolormap.length;
    }
