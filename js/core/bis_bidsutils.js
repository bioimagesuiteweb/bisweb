...
/**
 * Moves supporting files for dicom files that have already been moved by other operations. 
 * Call this function after image files have been moved around, e.g. by a user changing where files are in the file tree. 
 * 
 * @param {Array} movedFiles - New names of files that have already been moved.  
 * @param {String} baseDirectory - Name of the base directory of the study. 
 */
let syncSupportingFiles = (movedFiles, baseDirectory) => {
    ...
    bis_genericio.read(settingsFilename).then( (dicomSettings) => {

        console.log('dicom settings', dicomSettings);
