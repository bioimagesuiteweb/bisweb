 ...
 */
class LargeReslicingModule extends BaseModule {
    constructor() {
        super();
        this.name = 'largeReslicing';
        this.JSOnly=true;
        this.useworker=true;
    }
    ...
    async directInvokeAlgorithm(vals) {
        console.log('LargeReslicing invoking with vals', JSON.stringify(vals));
        ...
        try {
            ...
            return Promise.reject('Failed to read the header in largeReslice '+inputname);
        }
...
module.exports = LargeReslicingModule;
